	...
	return (
		<div className="bg-gradient-to-tr from-[#d11450] to-[#df293a]  w-full">
			<div className="p-5">
				...
				<form className="grid grid-cols-5 my-5 mx-auto w-8/12 ">
					<input
						name="city"
						type="text"
						value={city}
					...
					<Link href={`/hotels?city=${city}`}>
						<button
							type="submit"
							className="h-14 px-8 py-2 col-span-1 bg-[#2a984f] font-semibold text-lg text-white rounded-r-md hover:bg-green-500 duration-500 hover:text-xl"
						>
							Search
						</button>
					</Link>
